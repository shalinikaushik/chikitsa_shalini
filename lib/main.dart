                ...
                new Row(
                  ...
                  children: <Widget>[
                    ...
                    Column(
                        children: [
                          new Image.asset(
                              'images/guest.jpg', width: 50.0, height: 50.0
                          ),
                          new RaisedButton(
                            padding: const EdgeInsets.all(10.0),
...
class Newuser extends StatefulWidget {
  final String title;
  Newuser({Key key, this.title}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SeparatenewWidget(emailController, passwordController),
                SizedBox(
                  height: 10.0,
                ),
              ],
...
class SeparatenewWidget extends StatelessWidget {
  final TextEditingController emailController;
  final TextEditingController passwordController;

  SeparatenewWidget(this.emailController, this.passwordController);
